  ...
  <details>
    <summary>Table of Contents</summary>
      <ul class="toc">
        ...
        <li><a href="#sensible_defaults">Sensible Defaults</a></li>
      </ul>
  </details>
</nav>
...
- Front-Matter ready with minor edits
- Easy to (un)Comment/Delete based on requirements

```yaml
---
metadata:
  title: 'edit_me' # <title>, <meta name="title">, og|twitter:title
  name: 'edit_me' # <meta name="author">
  desc: 'edit_me' # <meta name="description">, og|twitter:description
  generator: 'eleventy' # <meta name="generator"> The value must be a free-form string that identifies one of the software packages used to generate the document. This value must not be used on pages whose markup is not generated by software, e.g. pages whose markup was written by a user in a text editor.
  comments: true # Display comments Open Graph & Twitter tags
  # og_comment: '' # custom comment for Open Graph tags. requires: `comments: true`
  # type: 'article|product' # The content for `og:type`. options: article, product; default: `website`
  url: 'edit_me' # og|twitter:url
  site_name: 'edit_me' # og:site_name.
  # locale: '' # locale for marked-up. default: `en_US` 
  # og_title: '' # og:title. default: `title`
  # og_desc: '' # og:description. default: `desc`
  img: 'edit_me' # og|twitter:image
  img_alt: 'edit_me' # og|twitter:image:alt
  # img_width: '' # og:image:width
  # img_height: '' # og:image:height
  # twitter_comment: '' # custom comment for Twitter tags. requires: `comments: true`
  # attr_name: 'property' # Define attribute name for Twitter meta tags. options: `property` default: `name`
  # twitter_card_type: 'summary_large_image' # `twitter:card`. options: `summary_large_image` default: `summary`
  twitter_handle: 'edit_me' # `twitter:site|creator` if `twitter_card_type: summary_large_image`.
  # creator_handle: '' # `twitter:creator`. This tag is used if `twitter_card_type: summary_large_image`.
  # twitter_title: '' # `twitter:title`. default: `title`
  # twitter_desc: '' # `twitter:description`. default: `desc`
---
```